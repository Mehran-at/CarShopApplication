...
// - In the CarShopApplication class main method, create a Seller and three Cars with different brands and use the Seller to describe the three of them. He should say that the three of them are particularly good.
